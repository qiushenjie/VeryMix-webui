...
class VideoUpscaling(TabBase):
    ...
    def render_tab(self):
        ...
        video_upload.change(lambda video_upload, sr_session_state:
                            (
                             gr.Button.update(interactive=((video_upload != None) and (sr_session_state.task_stop == None))),
                             gr.Button.update(interactive=(sr_session_state.task_stop != None))
                            ),
    ...
    def init_state(self,
        ...
        if video_upload:
            sr_session_state.video_input = video_upload.orig_name
        else:
    ...
    def run_enhance(self, sr_session_state, progress=gr.Progress()):
        ...
        sr_session_state.video_output = download_path
        sr_session_state.video_preview = preview_path
